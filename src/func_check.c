...
{
    text               *object_type_t  = PG_GETARG_TEXT_PP(0);
    text               *object_id_t    = PG_GETARG_TEXT_PP(1);
    text               *relation_t     = PG_GETARG_TEXT_PP(2);
    text               *subject_type_t = PG_GETARG_TEXT_PP(3);
    text               *subject_id_t   = PG_GETARG_TEXT_PP(4);

    bool                ok;

    const char *object_type  = text_to_cstring(object_type_t);
    const char *object_id    = text_to_cstring(object_id_t);
