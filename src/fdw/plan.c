...
void fgaGetForeignRelSize(PlannerInfo* root, RelOptInfo* baserel, Oid foreigntableid)
{
    FgaFdwTableOptions* opts = fga_get_table_options(foreigntableid);
...
void fgaGetForeignPaths(PlannerInfo* root, RelOptInfo* baserel, Oid foreigntableid)
{
    Cost startup_cost = 0;
...
ForeignScan* fgaGetForeignPlan(PlannerInfo* root,
                               RelOptInfo* baserel,
                               Oid foreigntableid,
