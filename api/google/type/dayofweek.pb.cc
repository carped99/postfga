...
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_google_2ftype_2fdayofweek_2eproto = nullptr;
...
const char descriptor_table_protodef_google_2ftype_2fdayofweek_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "o3"
  ;
static ::_pbi::once_flag descriptor_table_google_2ftype_2fdayofweek_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_google_2ftype_2fdayofweek_2eproto = {
    false, false, 362, descriptor_table_protodef_google_2ftype_2fdayofweek_2eproto,
    ...
    nullptr, file_level_enum_descriptors_google_2ftype_2fdayofweek_2eproto,
    file_level_service_descriptors_google_2ftype_2fdayofweek_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_google_2ftype_2fdayofweek_2eproto_getter() {
  return &descriptor_table_google_2ftype_2fdayofweek_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_google_2ftype_2fdayofweek_2eproto(&descriptor_table_google_2ftype_2fdayofweek_2eproto);
namespace google {
namespace type {
